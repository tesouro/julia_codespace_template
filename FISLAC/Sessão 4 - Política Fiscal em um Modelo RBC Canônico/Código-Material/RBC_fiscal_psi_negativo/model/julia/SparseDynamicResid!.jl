...
@inbounds begin
    residual[1] = ((y[25]+params[18]*y[41])^(-1)) - (params[1]*(y[49]+params[18]*y[65])^(-1)*(1+y[36])/(1+y[60])*(1+(1-y[62])*y[50]-params[3]));
    residual[2] = (y[27]) - (1-(y[25]+params[18]*y[41])*(1+y[36])*(1-params[4])/params[4]/(1-y[37])/y[31]);
    residual[3] = ((y[25]+params[18]*y[41])^(-1)) - (params[1]*(y[49]+params[18]*y[65])^(-1)*(1+y[36])/(1+y[60])*(1+y[32]));
    residual[4] = (y[30]) - (y[33]*y[4]^params[2]*y[27]^(1-params[2])*y[43]^params[19]);
