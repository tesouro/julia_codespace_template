...
@inbounds begin
    residual[1] = (y[10]) - ((1-params[1])*y[12]*y[2]^params[1]);
    residual[2] = (y[11]) - (params[1]*y[12]*y[2]^(params[1]-1)-params[2]);
    residual[3] = (y[9]/y[2]) - (1-params[2]+y[12]*y[2]^(params[1]-1)-y[8]/y[2]);
    residual[4] = (y[15]/y[8]) - ((y[14]*(1+params[1]*y[19]*y[9]^(params[1]-1)-params[2]))^(1/params[3]));
    residual[5] = (y[13]) - (y[12]*y[2]^params[1]);
