...
@inbounds begin
    residual[1] = ((y[27]+params[19]*y[43])^(-1)) - (params[1]*(y[53]+params[19]*y[69])^(-1)*(1+y[38])/(1+y[64])*(1+(1-y[66])*y[54]-params[3]));
    residual[2] = (y[29]) - (1-(y[27]+params[19]*y[43])*(1+y[38])*(1-params[4])/params[4]/(1-y[39])/y[33]);
    residual[3] = ((y[27]+params[19]*y[43])^(-1)) - (params[1]*(y[53]+params[19]*y[69])^(-1)*(1+y[38])/(1+y[64])*(1+y[34]));
    residual[4] = (y[32]) - (y[35]*y[4]^params[2]*y[29]^(1-params[2])*y[45]^params[20]);
