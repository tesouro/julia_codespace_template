...
@inbounds begin
    ...
    residual[2] = (y[7]) - (params[7]*(1+y[14])/(1-y[15])*y[3]^params[8]);
    residual[3] = (1) - (params[1]*(1+y[8]));
    residual[4] = (y[9]) - ((y[1]+params[4]*y[19]-params[7]*y[3]^(1+params[8])/(1+params[8]))^(-params[11])/(1+y[14]));
    residual[5] = (y[6]) - (y[10]*y[4]^params[2]*y[3]^(1-params[2])*y[21]^params[5]);
    ...
    residual[24] = (y[8]) - (y[27]+params[10]*(exp(y[28]/y[6]-params[29]/params[30])-1));
